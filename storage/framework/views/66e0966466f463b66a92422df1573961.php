...
<body>
    ...
    <div class="container-sm mt-5">
        <form action="<?php echo e(route('employees.store')); ?>" method="POST" <form action="<?php echo e(route('employees.store')); ?>"
...
<?php /**PATH C:\fifiapps\resources\views/employee/create.blade.php ENDPATH**/ ?>